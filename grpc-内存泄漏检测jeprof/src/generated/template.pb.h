...
#ifndef PROTOBUF_INCLUDED_template_2eproto
#define PROTOBUF_INCLUDED_template_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_template_2eproto 
...
namespace google {
namespace protobuf {
template<> ::greeter::Empty* Arena::CreateMaybeMessage<::greeter::Empty>(Arena*);
...
class Empty : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:greeter.Empty) */ {
 public:
  Empty();
  virtual ~Empty();
 ...
 private:
  ...
  friend struct ::protobuf_template_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class HelloRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:greeter.HelloRequest) */ {
 public:
  HelloRequest();
...
class HelloReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:greeter.HelloReply) */ {
 public:
  HelloReply();
  virtual ~HelloReply();
...
#endif  // PROTOBUF_INCLUDED_template_2eproto
